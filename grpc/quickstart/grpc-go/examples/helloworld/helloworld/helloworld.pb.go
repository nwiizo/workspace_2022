...
var file_helloworld_helloworld_proto_rawDesc = []byte{
	...
	0x00, 0x12, 0x43, 0x0a, 0x0d, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x41, 0x67, 0x65,
...
var file_helloworld_helloworld_proto_depIdxs = []int32{
	...
	0, // 1: helloworld.Greeter.SayHelloAgein:input_type -> helloworld.HelloRequest
	1, // 2: helloworld.Greeter.SayHello:output_type -> helloworld.HelloReply
	1, // 3: helloworld.Greeter.SayHelloAgein:output_type -> helloworld.HelloReply
